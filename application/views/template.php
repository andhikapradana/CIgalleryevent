    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Dotagram . Biggest Dota Forum</a>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>Byanta</b> deleted account</h4>
                                                <p>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>Ferdiananda</b> changed name</h4>
                                                <p>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>Andhika</b> commented your post</h4>
                                                <p>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Andhika Pradana Byantara</div>
                    <div class="email">andhika_pradana_26rpl@student.smktelkom-mlg.sch.id</div>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 - 2019 <a href="javascript:void(0);">XI RPL 2 - Tugas 2 Produktif</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
